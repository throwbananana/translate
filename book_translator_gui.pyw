...
class BookTranslatorGUI:
    ...
    def __init__(self, root):
        ...
        self.translation_run_guard = TranslationRunGuard()
    ...
    def start_translation(self):
        ...
        # 计算签名用于断点恢复判断，并通过 controller 生成本次会话快照
        ...
        self.progress_var.set(start_state.initial_progress)
    ...
    def translate_segment(self, api_type, text, context=None, config=None):
