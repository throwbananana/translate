...
git apply --check 0001-project-hardening-readme-deps-tests-ci-fixed.patch || goto :error
...
git apply 0001-project-hardening-readme-deps-tests-ci-fixed.patch || goto :error
